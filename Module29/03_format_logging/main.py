...
# спасибо гуглу, за решение этой задачи. и опять модуль time и datetime, про который было сказано буквально 8 слов,
# за все время обучения!
# как здорово, что Вам в итоге с этими модулями удалось более-менее разобраться.
# напомню, навык поиска и адаптации информации к решению задач - необходимый навык!
